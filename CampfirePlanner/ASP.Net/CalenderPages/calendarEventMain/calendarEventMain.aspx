...
<asp:Content ID="Content3" ContentPlaceHolderID="body2" runat="server">
    <main>
        ...
        <div>
            ...
            <asp:GridView ID="gvEvents" runat="server" EmptyDataText="There are no Events!" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnSelectedIndexChanged="gvEvents_SelectedIndexChanged">
